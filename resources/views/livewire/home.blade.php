        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <h1 class="text-5xl md:text-7xl font-bold text-white tracking-tight mb-6">
                    Building the <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Future</span> of <br class="hidden md:block"/>
                    Intelligent Web Systems.
                </h1>
                
                <p class="text-xl text-slate-400 mb-10 leading-relaxed max-w-2xl mx-auto">
                    Senior Full-Stack Architect with 9+ years of experience, now engineering autonomous agents and scalable AI solutions for the enterprise.
                </p>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="https://linkedin.com/in/ichsan-dwi-nugraha" target="_blank" class="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-semibold border border-slate-700 transition flex items-center justify-center">
                        Download CV
    ...
    <section id="services" class="py-20 bg-slate-900/50 border-t border-slate-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <!-- Service 2 -->
                <div class="bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50 hover:border-cyan-500/30 transition group">
                    <div class="w-12 h-12 bg-cyan-500/10 rounded-lg flex items-center justify-center text-cyan-400 mb-6 group-hover:scale-110 transition">
                ...
                <!-- Service 3 -->
                <div class="bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50 hover:border-emerald-500/30 transition group">
                    <div class="w-12 h-12 bg-emerald-500/10 rounded-lg flex items-center justify-center text-emerald-400 mb-6 group-hover:scale-110 transition">
