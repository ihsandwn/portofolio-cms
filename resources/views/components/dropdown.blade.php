@props(['align' => 'right', 'width' => '48', 'contentClasses' => 'py-1 bg-surface-container-lowest border border-outline-variant/20'])
...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="ring-1 ring-outline-variant/20 {{ $contentClasses }}">
            {{ $content }}
        </div>
    </div>
</div>
